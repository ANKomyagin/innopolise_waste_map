...
from app.core.auth import verify_admin  # ✅ Добавлен импорт для проверки прав
...
async def get_scan_logs(
        ...
        current_user: dict = Depends(verify_admin)  # ✅ Защита эндпоинта: только для администраторов
):
    """Get scan logs for analysis (admin only)"""
